...
<html lang="en">
  <head>
    ...
    <title>CountryDetailsIntent View URL</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="FilterPage.php">CountryDetailsIntent</a>
        </div>
...
?>    
  ...
  <?php
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted">© Copyright CountryDetailsIntent Inc, 2017</p>
      </div>
    </footer>
<?php 
